import { NativeRecordingStrategy } from '@/features/media/recording/strategies/native-recording-strategy'
import type { RecordingConfig } from '@/features/media/recording/types/recording-strategy'
