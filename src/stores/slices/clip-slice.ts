 ...
 * Clip Slice
 *
 * Manages clip CRUD operations, speed-up, and undo restoration.
 * This is the largest slice containing all clip manipulation logic.
 */
...
import type { CreateClipSlice } from './types'
import { invalidateCaches } from './utils'

export const createClipSlice: CreateClipSlice = (set, get) => ({
  // Actions
