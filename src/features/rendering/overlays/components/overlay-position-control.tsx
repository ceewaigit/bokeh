        ...
        {ANCHOR_GRID.map((gridAnchor) => {
          ...
          return (
            <button
              ...
              className={cn(
                "h-6 w-6 rounded-lg transition-all duration-100 flex items-center justify-center relative",
                isSelected
            ...
            >
              ...
              {isOccupied && (
                <div className="absolute -top-0.5 -right-0.5 h-2 w-2 rounded-lg bg-amber-500/70 ring-1 ring-background" />
              )}
            </button>
          )
        })}
