...
import { PROJECT_EXTENSION, PROJECT_PACKAGE_FILE, buildProjectFilePath } from '@/features/storage/recording-storage'
  ...
  private static async ensurePreviewProxy(
    ...
    try {
      ...
      if (checkResult.existingProxyUrl) {
        ...
        import('@/features/stores/project-store').then(({ useProjectStore }) => {
