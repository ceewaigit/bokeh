  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        <Label className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">Social</Label>
        <div className="grid grid-cols-3 gap-1.5">
      ...
      <div className="space-y-1.5">
        <Label className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">Landing Page</Label>
      ...
      {currentPreset === AspectRatioPreset.Custom && (
        <div className="space-y-1.5 pt-2 border-t">
          <Label className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">Custom Dimensions</Label>
...
function MockupSection({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-1.5">
        <Label className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">Device Type</Label>
        <div className="grid grid-cols-3 gap-1.5">
      ...
      {mockupData.deviceType !== DeviceType.None && availableModels.length > 0 && (
        <div className="space-y-1.5">
          <Label className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">Device Model</Label>
          <Select
      ...
      {mockupData.enabled && (
        <>
          {/* Video Fit Mode */}
          <div className="space-y-1.5">
            <Label className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">Video Fit</Label>
          ...
          {hasCustomVariants && (
            <div className="space-y-1.5">
              <Label className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">Color Variant</Label>
              <Select
