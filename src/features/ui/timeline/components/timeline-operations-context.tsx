...
export interface TimelineContextValue {
  ...
  onDragPreview: (clipId: string, trackType: TrackType.Video | TrackType.Audio | TrackType.Webcam, proposedStartTime: number) => void
  onDragCommit: (clipId: string, trackType: TrackType.Video | TrackType.Audio | TrackType.Webcam, proposedStartTime: number) => void
